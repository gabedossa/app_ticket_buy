...
const styles = StyleSheet.create({
    ...
    categoriesSection: { backgroundColor: "white", paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#e0e0e0" },
    categories: { paddingHorizontal: 16, alignItems: 'center' },
    ...
    categoryBtnText: { color: "#333", fontWeight: "500", fontSize: 14, textTransform: "capitalize" },
    ...
    logoutButton: { paddingVertical: 8, paddingHorizontal: 16, backgroundColor: '#ff4d4d', borderRadius: 20, marginLeft: 10 },
